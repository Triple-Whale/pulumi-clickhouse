...
tar -zcvf pulumi-resource-clickhouse-v0.0.36-darwin-arm64.tar.gz pulumi-resource-clickhouse
gsutil cp pulumi-resource-clickhouse-v0.0.36-darwin-arm64.tar.gz gs://pulumi-shofifi/clickhouse/
cd ../..
cd dist/pulumi-clickhouse_linux_amd64_v1
tar -zcvf pulumi-resource-clickhouse-v0.0.36-linux-amd64.tar.gz pulumi-resource-clickhouse
gsutil cp pulumi-resource-clickhouse-v0.0.36-linux-amd64.tar.gz gs://pulumi-shofifi/clickhouse/
cd ../..
```
