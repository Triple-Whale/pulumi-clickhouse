...
import (
	...
	clickhouse "github.com/Triple-Whale/terraform-provider-clickhouse/pkg/provider"

	"github.com/Triple-Whale/pulumi-clickhouse/provider/pkg/version"
)
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Keywords:   []string{"triplewhale", "clickhouse", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/Triple-Whale/pulumi-clickhouse/sdk/",
